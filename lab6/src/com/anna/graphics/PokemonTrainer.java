...
public class PokemonTrainer extends JFrame{
    ...
    public void createSceneGraph(SimpleUniverse su){
        ...
        addImageBackground("source_folder/background.jpg", trainerBranchGroup);
        ...
        setToMyDefaultAppearance(headApp, new Color3f(0.3f, 0.1f, 0.1f));
        ...
        setToMyDefaultAppearance(ballApp, new Color3f(0.9f, 0.9f, 0.0f));
        ...
        setToMyDefaultAppearance(bodyApp, new Color3f(0.0f, 0.2f, 0.0f));
        ...
        setToMyDefaultAppearance(bagApp, new Color3f(0.0f, 0.0f, 0.4f));
