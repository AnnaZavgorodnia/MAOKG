...
public class PrintingImage extends Application{
    ...
    private HeaderBitmapImage image; // приватне поле, яке зберігає об'єкт інформацією про заголовок зображення
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        ReadingImageFromFile.loadBitmapImage("./sources/trajectory2.bmp");
